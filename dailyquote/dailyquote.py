    ...
    async def generate_image_from_quote(self, quote_text, author):
        ...
        try:
            ...
            response = self.client.images.generate(
                prompt=f'Create a humorous, entertaining, and whimsical photorealistc image with exaggerated features. Use the following quote purely as inspiration: "{quote_text}" - {author}. Do not include any text, letters, or numbers in the image—only visual elements.',
                model="dall-e-3",
                n=1,
                size="1024x1024"
            )
